...
export const resumeLabels = {
  ...
  expandProject: localized("Details", "项目详情", "專案詳情", "פרטים", "التفاصيل"),
  collapseProject: localized("Close details", "收起详情", "收起詳情", "סגירת פרטים", "إغلاق التفاصيل"),
} as const;
...
export const projects = [
  { id: "zelaze", status: "featured" as ProjectStatus, image: "/assets/projects/zelaze.png", title: "Zelaze", description: localized("A customized mutual-assistance service built as an ITC final group project.", "ITC 小组毕业项目：定制化互助服务平台。", "ITC 小組畢業專案：客製化互助服務平台。", "שירות עזרה הדדית מותאם אישית שנבנה כפרויקט גמר קבוצתי ב-ITC.", "خدمة مساعدة متبادلة مخصصة بُنيت كمشروع تخرج جماعي في ITC."), details: localized("Designed around matching people who need help with nearby community members, combining service discovery, requests, and account workflows.", "围绕求助者与附近社区成员的匹配设计，整合服务发现、请求流程和账户工作流。", "圍繞求助者與附近社群成員的配對設計，整合服務探索、請求流程和帳戶工作流程。", "עיצוב סביב התאמה בין מבקשי עזרה לחברי קהילה קרובים, עם גילוי שירותים, בקשות ותהליכי חשבון.", "مصمم لربط طالبي المساعدة بأفراد المجتمع القريبين، مع اكتشاف الخدمات والطلبات ومسارات الحساب."), stack: ["React", "TypeScript", "Node.js"], href: "https://github.com/Him97" },
  { id: "llama", status: "developing" as ProjectStatus, image: "/assets/projects/little-llama.png", title: "Little Llama", description: localized("A full-stack pet adoption service, currently being refined for deployment.", "全栈宠物领养服务，目前正在完善并准备部署。", "全端寵物領養服務，目前正在完善並準備部署。", "שירות אימוץ חיות full-stack שנמצא כעת בשיפור לקראת deployment.", "خدمة متكاملة لتبني الحيوانات يجري تحسينها حالياً تمهيداً للنشر."), details: localized("The next release focuses on a clearer adoption funnel, stronger validation, refreshed responsive UI, and deployment-ready data flows.", "下一版本重点完善领养漏斗、数据校验、响应式界面以及可部署的数据流程。", "下一版本重點完善領養流程、資料驗證、響應式介面以及可部署的資料流程。", "הגרסה הבאה מתמקדת בתהליך אימוץ ברור יותר, validation, ממשק רספונסיבי וזרימות נתונים מוכנות ל-deployment.", "يركز الإصدار التالي على مسار تبنٍ أوضح وتحقق أقوى وواجهة متجاوبة وتدفقات بيانات جاهزة للنشر."), stack: ["React", "Express", "MongoDB"], href: "https://github.com/him-li/littlellama" },
  { id: "lemon", status: "repository" as ProjectStatus, image: "/assets/projects/little-lemon.png", title: "Little Lemon", description: localized("A responsive restaurant experience created for the Meta frontend capstone.", "为 Meta 前端结业项目创建的响应式餐厅体验。", "為 Meta 前端結業專案建立的響應式餐廳體驗。", "חוויית מסעדה רספונסיבית שנבנתה לפרויקט הגמר של Meta Frontend.", "تجربة مطعم متجاوبة أُنشئت لمشروع التخرج في برنامج Meta للواجهات."), details: localized("A usability-led booking flow supported by semantic components, responsive layouts, form validation, and focused interaction tests.", "以可用性为核心的预订流程，包含语义化组件、响应式布局、表单校验和关键交互测试。", "以可用性為核心的預訂流程，包含語意化元件、響應式版面、表單驗證和關鍵互動測試。", "תהליך הזמנה מונחה-שימושיות עם רכיבים סמנטיים, layout רספונסיבי, אימות טפסים ובדיקות אינטראקציה.", "تدفق حجز يركز على سهولة الاستخدام مع مكونات دلالية وتخطيطات متجاوبة والتحقق من النماذج واختبارات التفاعل."), stack: ["React", "UX", "Testing"], href: "https://github.com/him-li/meta-react-littlelemon" },
] as const;
